 ...
 * @author andrea
 */
public class Jfr_Chat extends javax.swing.JFrame implements Runnable{
    ...
    private void BtnConectarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnConectarActionPerformed
         try {
            ...
            t=new Thread(this);
            t.start();
            this.BtnConectar.setVisible(false);
    ...
    public void run(){
        try {
             while(true){
               ...
               if(message !=null){
                   String content= "";
                   content += this.Txt_Contenido.getText()+message.getText()+ "\n";
                   this.Txt_Contenido.setText(content);
             } 
                 Thread.sleep(100);
             }
        } catch (Exception e) {
